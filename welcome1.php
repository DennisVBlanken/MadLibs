...
<div id="container">
<p> Er heerst paniek in het koninkrijk Gallifrey. Koning Egmond is ten einde raad en als koning Egmond ten einde raad is, dan roept hij zijn ten-einde-raadsheer <?php echo $_POST["persoon"] ?>.</p>
...
<footer><p id="footer">Made by Dennis</p></footer>
</body>
</html>
